...
const Footer = () => {
  ...
  const socialLinks = [
    {
      title: "GitHub",
      href: "https://github.com/nirmal2604",
      icon: (
        <svg
    ...
    {
      title: "LinkedIn",
      href: "https://www.linkedin.com/in/nirmal-modi-1a7b212b7/",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h3 className="mb-3 text-lg font-bold">AlgoFlow</h3>
        ...
        >
          <p>
            © {new Date().getFullYear()} AlgoFlow. All rights
            reserved.
          </p>
...
const privacyContent = (
  <div className="space-y-4">
    <p>
      ...
      used, and shared when you visit AlgoFlow.
    </p>
...
const termsContent = (
  <div className="space-y-4">
    <p>By using AlgoFlow, you agree to these Terms of Service.</p>
    ...
    <p>
      The materials on AlgoFlow are provided on an &apos;as is&apos;
      basis. AlgoFlow makes no warranties, expressed or implied, and
      hereby disclaims and negates all other warranties.
    </p>

    <h4 className="font-semibold text-white">Limitations</h4>
    <p>
      In no event shall AlgoFlow or its suppliers be liable for any
    ...
    <p>
      The materials appearing on AlgoFlow could include technical,
      typographical, or photographic errors. AlgoFlow does not warrant
