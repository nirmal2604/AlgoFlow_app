      ...
      default:
        return (
          <div className="text-center text-gray-400 mt-12">
            Select a mathematical algorithm to visualize
          </div>
        );
    }
  };
        ...
        <div className="p-4 bg-slate-800 rounded-lg">
          ...
          <div className="text-sm text-gray-300">
            {algorithm === "gcd-(euclidean)" ? (
              <>
                <p>
                  The Euclidean algorithm is an efficient method for computing
                  the greatest common divisor (GCD) of two integers.
                </p>
                <p className="mt-2">
                  It works by repeatedly applying the division algorithm and
                  taking remainders until reaching zero.
                </p>
              ...
              <>
                <p>
                  Prime factorization is the process of determining which prime
                  numbers multiply together to form a given composite number.
                </p>
                <p className="mt-2">
                  The algorithm works by testing potential prime factors,
                  starting with 2, and dividing repeatedly until reaching 1.
                </p>
                <p className="mt-2">
                  Every composite number can be expressed uniquely as a product
                  of primes (Fundamental Theorem of Arithmetic).
                </p>
              </>
            ) : (
